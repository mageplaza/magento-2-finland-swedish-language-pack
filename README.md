...
2. [Install Finland Swedish Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Finland Swedish language pack](#3-how-to-active-hungarian-language-pack)
...
```
unzip master.zip app/i18n/Mageplaza/sv_fi
```
...
## 3. How to active Finland Swedish language pack {#active}
